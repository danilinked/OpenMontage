...
| **Camera direction** | `camera-movements` (pan/tilt/dolly/truck/pedestal/zoom/crane/orbit/handheld taxonomy + prompt phrasing, for image-to-video and text-to-video camera prompts) |
